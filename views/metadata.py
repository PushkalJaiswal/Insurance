...
def load_view():
    ...
    st.markdown('\n')
    st.markdown('\n')
    st.title('Change Meta Data')

    # Add the expander to provide some information about the app
    with st.sidebar.expander("About the App"):
        st.write("""This application is created to help the user change the metadata for the uploaded file.
    ...
    if 'main_data.csv' not in os.listdir('data'):
        ...
        print(current_type)
        column_options = ['numeric', 'numerical', 'categorical', 'object']
